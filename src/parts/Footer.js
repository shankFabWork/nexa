    ...
    <div className="bg-gray-50 border-t border-gray-200 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between mt-8 gap-10">
          ...
          {/* Office */}
          <div className="w-full lg:w-1/3">
            <h1 className="text-lg text-theme-blue pb-2">Office</h1>
            <p className="text-base lg:text-lg text-gray-400 font-light break-words">
          ...
          {/* Social */}
          <div className="w-full lg:w-1/3">
            <h1 className="text-lg text-theme-blue pb-2">Social</h1>
            <div className="flex flex-col space-y-1">
              <Button
                href="https://www.instagram.com/racmathafidz/"
                type="link"
                target="_blank"
                className="text-base lg:text-lg text-gray-400 font-light hover:underline"
                isExternal
              >
                Instagram
              </Button>
        ...
        <div className="text-center mt-10">
          <p className="text-base lg:text-lg text-gray-400 font-light">
            ...
            <a href="/" className="text-blue-400 hover:underline">NexaQuark Consulting</a>
          </p>

          <div className="flex flex-col sm:flex-row justify-center items-center flex-wrap gap-1 mt-3">
            <span className="text-base lg:text-lg text-gray-400 font-light">Made with ❤️ by</span>
            <div className="flex flex-wrap justify-center gap-x-2">
              <Button
                href="https://www.linkedin.com/in/shashank-sharma-b05846175/"
                type="link"
                target="_blank"
                className="text-base lg:text-lg text-purple-700 font-light hover:text-blue-700 whitespace-nowrap"
                isExternal
              >
                Shashank Sharma
              </Button>
              <span className="text-base lg:text-lg text-theme-purple font-light">&</span>
              <Button
